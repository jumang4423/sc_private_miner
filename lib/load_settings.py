...
def print_settings(settings):
    ...
    """
    print(f"PRIVATE_SMALL_ARTIST_URLS_FILENAME: {settings['PRIVATE_SMALL_ARTIST_URLS_FILENAME']}")
    print(f"PRIVATE_BIG_ARTIST_URLS_FILENAME: {settings['PRIVATE_BIG_ARTIST_URLS_FILENAME']}")
    print(f"PUBLIC_SMALL_PLAYCOUNT_URLS_FILENAME: {settings['PUBLIC_SMALL_PLAYCOUNT_URLS_FILENAME']}")
    print(f"PUBLIC_BIG_PLAYCOUNT_URLS_FILENAME: {settings['PUBLIC_BIG_PLAYCOUNT_URLS_FILENAME']}")
